...
public class Constants {//создаем класс Constants
    ...
    public static final String MESSAGE_FIRST_NUMBER = "Enter first number";
    public static final String MESSAGE_SECOND_NUMBER = "Enter second number";
    public static final String MESSAGE_OPERATOR = "Enter '+', '-', '/', '*'";
